      ...
      $container.each(function () {
        ...
        $this.countdown(finalDate, function (event) {
          var $this = jQuery(this).html(
            event.strftime(
              " " +
                '<span class="timer-count">%-D <span class="timer-text">' +
                day +
                "</span></span>  " +
                '<span class="timer-count">%H <span class="timer-text">' +
                hour +
                "</span></span> " +
                '<span class="timer-count">%M <span class="timer-text">' +
                minute +
                "</span></span> " +
                '<span class="timer-count">%S <span class="timer-text">' +
                second +
                "</span></span>"
            )
          );
