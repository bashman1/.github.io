  ...
  if (count_down.length > 0) {
    ...
    count_down.countdown(ful_date, function (event) {
      var $this = $(this).html(
        event.strftime(
          " " +
            '<div class="xs-timer-container"><span class="timer-count">%-D </span><span class="timer-text">' +
            countdown_variable.days +
            "</span></div>" +
            '<div class="xs-timer-container"><span class="timer-count">%H </span><span class="timer-text">' +
            countdown_variable.hours +
            "</span></div>" +
            '<div class="xs-timer-container"><span class="timer-count">%M </span><span class="timer-text">' +
            countdown_variable.minutes +
            "</span></div>" +
            '<div class="xs-timer-container"><span class="timer-count">%S </span><span class="timer-text">' +
            countdown_variable.seconds +
            "</span></div>"
        )
      );
    });
